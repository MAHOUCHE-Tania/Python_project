...
class Monster:
    # Class du Hero , qui contient les éléments qui vont être utilisés lors des combats :
    # points d'attaques, points de vie , et inventaire. Ainsi on limite le nombre de fonctions.
    # Cette même classe est utilisée pour tous les niveaux qui impliquent Les ROVINOS = les méchants que doit battre BOB.
    ...
    Vie_monstres = property(_get_health_Monster,_set_health_Monster)
    # Utilisations de proprités pour pouvoir modifier les attributs de la méthode _init_ . l'extérieur de la Classe.
...
class BOB:
    # Class du Hero , qui contient les éléments qui vont être utilisés lors des combats :
    # points d'attaques, points de vie , et inventaire.
    ...
    Vie = property(_get_health,_set_health)
    # Utilisations de proprités pour pouvoir modifier les attributs de la méthode _init_ . l'extérieur de la Classe.
